...
Shader "SBCameraScroll/UnderWaterLight" //Unlit Transparent Vertex Colored Additive 
{
Properties 
	{
...
#if RoomHasBrainMold
dist = lerp(dist,.0,_BrainMoldMask(i.scrPos+distortion));
#endif
...
half4 result = half4(i.clr.xyz, dist * i.clr.w * lerp(0.75, 0.5, centerDist));
