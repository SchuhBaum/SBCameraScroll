...
[BepInPlugin("SBCameraScroll", "SBCameraScroll", "3.0.7")]
public class MainMod : BaseUnityPlugin {
    ...
    public static readonly string version = "3.0.7";
    ...
    private void RainWorld_OnModsInit(On.RainWorld.orig_OnModsInit orig, RainWorld rain_world) {
        ...
        //     Debug.Log($"{mod_id}: CRS found. Adept merging when the `REPLACEROOM` feature is used.");
        // } else {
        //     Debug.Log($"{mod_id}: CRS not found.");
        // }
