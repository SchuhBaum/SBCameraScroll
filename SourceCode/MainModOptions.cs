...
public class MainModOptions : OptionInterface
{
    ...
    public static Configurable<bool> regionMods = instance.config.Bind("regionMods", defaultValue: false, new ConfigurableInfo("When enabled, and region mods are enabled or disabled the corresponding cached room textures get cleared.", null, "", "Region Mods"));
