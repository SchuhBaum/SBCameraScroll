...
1. Download the file  `SBCameraScroll.zip` from [Releases](https://github.com/SchuhBaum/SBCameraScroll/releases/tag/v2.4.2).
...
v2.4.2:
- Fixed a bug where the camera was not centered.
