...
1. Download the file  `SBCameraScroll.zip` from [Releases](https://github.com/SchuhBaum/SBCameraScroll/releases/tag/v2.9.3).
...
#### (Rain World v1.9)
v2.9.3:
- (just-in-time merging) Fixed a bug that could cause an infinite loop in the mod `Rain Meadow`.
