...
1. Download the file  `SBCameraScroll.zip` from [Releases](https://github.com/SchuhBaum/SBCameraScroll/releases/tag/v2.3.3).
...
- Enabled a (small) camera offset in x by default. I still consider it experimental but this way more people can experience it.
